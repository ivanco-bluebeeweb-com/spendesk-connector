...
async def connect_spendesk(ctx, params: ConnectParams) -> ActionResult[ConnectionRecord]:
...
async def disconnect_spendesk(ctx, params: ConnectionIdParams) -> ActionResult[DeleteResult]:
