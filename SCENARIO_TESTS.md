# Plausible Scenario Tests (PST) — Spendesk Connector
...
- `connect_spendesk`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_spendesk`: validated contract & error handling
