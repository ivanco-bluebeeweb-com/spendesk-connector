"""Settings panel for Spendesk Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__spendesk_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=spendesk_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_spendesk"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Spendesk Settings & Accounts", level=2),
